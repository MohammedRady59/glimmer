...
allDatalatestProducts.forEach(
  (el, idx) =>
    (latestProductsContainer += `  <div class="bg-[#F7F2E9] p-2 rounded-lg md:w-[280px] w-[156px] md:h-[430px] h-[240px] flex-col gap-4">
  <div class="md:w-[260px] md:h-[275px] w-[140px] h-[150px] relative group overflow-hidden">
